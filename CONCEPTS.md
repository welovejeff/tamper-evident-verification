...
### Anchor
An external, public witness that a Chain existed byte-for-byte at a point in time, independent of the signing key. Anchoring records the chain in an append-only transparency log under a personal or CI identity; verification enforces the identity recorded at anchor time. An anchor proves existence-at-a-time, not correctness, and says nothing about moments before it.
